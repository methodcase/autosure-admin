...
//# sourceMappingURL=C:/Users/IBM_ADMIN/bluemix/autosure-admin/src/data.service.js.map
...
var AppComponent = (function () {
    function AppComponent(data) {
        ...
        this.selectModel = function () {
            ...
            var make = args[0];
            _this.data.getCompute(_this.year, make).subscribe(function (items) {
    ...
    AppComponent.prototype.compute = function () {
        ...
        this.data.getCompute(this.year, this.value).subscribe(function (items) { return _this.computedValue = items; });
    };
    ...
    AppComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.data.getMakes().subscribe(function (items) {
            _this.makes = items;
        });
        this.data.getModels().subscribe(function (items) {
            _this.models = items;
        });
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__icon_icon_component__ = __webpack_require__(456);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__quote_icon_quote_icon_component__ = __webpack_require__(459);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__makes_makes_component__ = __webpack_require__(457);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__models_models_component__ = __webpack_require__(458);
...
//# sourceMappingURL=C:/Users/IBM_ADMIN/bluemix/autosure-admin/src/makes.component.js.map
...
//# sourceMappingURL=C:/Users/IBM_ADMIN/bluemix/autosure-admin/src/models.component.js.map
...
module.exports = "<select name=\"\" id=\"\" class=\"form-control\" (change)=handleChange($event.target.value)>\n  <option [value]=\"\"></option>\n  <option *ngFor=\"let make of makes\" [value]=\"make.makeId\">{{make.car_make}}</option>\n</select>"
...
module.exports = "<select name=\"\" id=\"\" class=\"form-control\" (change)=selectModel($event.target.value)>\n  <option></option>\n  <option [value]=\"model.value\" *ngFor=\"let model of models\">{{model.car_model}}</option>\n</select>"
